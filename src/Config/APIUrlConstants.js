...
// dashboard API list
const APPROVE_USER_WITH_MAIL = `${ENV}/dashboard/approveUserWithRole`;
const GET_USER_DETAILS = `${ENV}/dashboard/getUserDetails`;
const GET_FRESHCHAT_RESTORE_ID_API = `${ENV}/dashboard/getFreshchatRestoreId`;
const UPDATE_RESTORE_ID_API = `${ENV}/dashboard/updateFreshchatRestoreId`;
const UPDATE_PROFILE = `${ENV}/dashboard/updateProfile`;
...
const CHECK_EMAIL = `${ENV}/dashboard/checkEmail`;
...
const LIST_SYSTEM_TYPE = `${ENV}/ticket/getSystemType`;
