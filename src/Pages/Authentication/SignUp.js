          ...
          <div className="boxRight d-flex flex-column align-items-center">
            <div className="mainWrap d-flex flex-column justify-content-center">
              <div className="regTxt d-flex align-items-start flex-column">
                <img src={process.env.REACT_APP_PUBLIC_URL + 'images/login/logo.png'} alt="logoImg" className="logoImg" />
              </div>
                  ...
                  <Col>
                    <Form.Group controlId="formOrganization">
                      <Form.Control
                        ...
                        data-validity={validity}
                      />
                      <Form.Control.Feedback type="invalid">Organization is required</Form.Control.Feedback>
                    </Form.Group>
                  </Col>
                </Row>
