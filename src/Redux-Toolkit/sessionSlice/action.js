...
export const userLogin = createAsyncThunk(
    'session/userLogin',
    async (urlencoded, { rejectWithValue }) => {
...
export const getSSOUser = createAsyncThunk(
    'session/getSSOUser',
...
export const updateSSOUser = createAsyncThunk(
    'session/updateSSOUser',
...
export const successData = createAsyncThunk(
    'session/successData',
...
export const fetchNotifyData = createAsyncThunk(
    'session/fetchNotifyData',
...
export const removeNotifyData = createAsyncThunk(
    'session/removeNotifyData',
    async (ids) => {
