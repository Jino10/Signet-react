...
export const userAllTickets = createAsyncThunk(
    'ticket/userAllTickets',
...
export const fetchPriorityData = createAsyncThunk(
    'ticket/fetchPriorityData',
    async () => {
...
export const ticketsUpdate = createAsyncThunk(
    'ticket/ticketsUpdate',
    async (ticketObject, { rejectWithValue }) => {
