...
export const allUsersList = createAsyncThunk(
    'user/allUsersList',
...
export const deleteUserId = createAsyncThunk(
    'user/deleteUserId',
    async ({ id, dUser }, { rejectWithValue }) => {
...
export const createUser = createAsyncThunk(
    'user/createUser',
    async ({ endPoint, user }, { rejectWithValue }) => {
...
export const fullUserDetails = createAsyncThunk(
...
export const postData = createAsyncThunk(
    'user/postData',
    async ({ optionval, msg, search, message }) => {
