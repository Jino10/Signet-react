...
describe('SignUp page', () => {
  ...
  it('should render all texts and images', async () => {
    expect(screen.getByText(aboutSignet)).toBeInTheDocument();
    const signetLogoImg = screen.getByAltText(/logoImg/i);
    expect(signetLogoImg).toBeInTheDocument();
  });
  ...
  it('should be failed on validation', async () => {
    ...
    expect(screen.getByText('Organization Email is required')).toBeVisible();
